...
void Level::add_screen_object(Screen_object* obj, std::string msg){
    if (msg != "N_A"){
        if (msg == "m_o")
            machine_opp.push_back(obj);
        else if (msg == "m_p")
            machine_p.push_back(obj);
        else if (msg == "boss")
            Objects_elite.push_back(obj);
        else if (msg == "i")
            Items.push_back(obj);
        else if (msg == "b")
            Bullet.push_back(obj);
        else if (msg == "b_p")
            Bullet_p.push_back(obj);
        else{}
    }
}
